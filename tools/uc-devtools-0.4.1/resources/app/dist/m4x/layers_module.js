...
return Promise.rejectWithError("Internal error: not a WebInspector.DeferredLayerTree");var panel=WebInspector.LayersPanel._instance();WebInspector.inspectorView.setCurrentPanel(panel);panel._showLayerTree((snapshotData));return Promise.resolve();}}
