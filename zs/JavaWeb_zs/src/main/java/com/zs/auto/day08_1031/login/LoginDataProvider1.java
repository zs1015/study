...
public class LoginDataProvider1 {
    ...
    protected static Object[][] data_fail() {
        /*
         * return new Object[][]{ new Object[] {"","","用户名不能为空"}, new Object[]
         * {"asdf","","非法的手机号"}, new Object[] {"13566667777","","密码不能为空"}, new
         * Object[] {"13566667777","1234554658686","账号信息错误"} };
         */
    ...
    protected static Object[][] data_success() {
        ...
        // 3.再放在数据提供者(@DataProvider)的二维数组中
        for (int i = 0; i < read.size(); i++) {
            // LoginSuccessData loginSuccessData = (LoginSuccessData)
            // read.get(i);//这句是废话
            Object[] itemArray = { read.get(i) };
            datas[i] = itemArray;
        }
